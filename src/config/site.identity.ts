export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'rhbookstore',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Rhbookstore',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'rhbookstore.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://rhbookstore.com',
